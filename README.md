...
- [login_test.robot](https://github.com/Hege3000/frontend-vite/blob/master/tests/front/login_test.robot)
...
- [webform_test.robot](https://github.com/Hege3000/frontend-vite/blob/master/tests/front/webform_test.robot)

### Tehtävä 4 — Päiväkirjamerkinnän lisääminen
Testi kirjautuu sovellukseen ja lisää uuden päiväkirjamerkinnän.
- [entry_test.robot](https://github.com/Hege3000/frontend-vite/blob/master/tests/front/entry_test.robot)
...
- [crypto_login_test.robot](https://github.com/Hege3000/frontend-vite/blob/master/tests/front/crypto_login_test.robot)
